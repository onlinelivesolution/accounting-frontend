        ...
        <div className="grid grid-cols-6 gap-4 pt-1">
            <div className="grid grid-cols-6 col-span-6 bg-white p-4 border border-blue-300 rounded-lg gap-2">
                ...
                <div className="col-span-6 w-full h-[450px] overflow-x-auto overflow-y-auto border border-blue-300 rounded-lg">
                    <table className="min-w-full table-fixed text-[10px] border-l border-blue-300 border-r border-blue-300 rounded-lg">
                        <thead className="bg-blue-300 border-b border-blue-300">
                            <tr>
                                ...
                                <th className="w-[220px] p-2 border-b border-blue-300 text-left">Customer Name</th>
                                <th className="w-[220px] p-2 border-b border-blue-300 text-left">Quotation No</th>
                                <th className="w-[220px] p-2 border-b border-blue-300 text-left">Date Creation</th>
                                <th className="w-[220px] p-2 border-b border-blue-300 text-left">Total Amount</th>
                                <th className="w-[220px] p-2 border-b border-blue-300 text-left">Status</th>
                                    ...
                                    <tr>
                                        <td className="w-[50px] py-2 px-2 text-center border-b border-blue-300 border-l border-blue-300">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <button
                                                    className="w-4 h-4 flex items-center justify-center text-white text-lg pb-[5px] bg-blue-500 rounded hover:bg-blue-600"
